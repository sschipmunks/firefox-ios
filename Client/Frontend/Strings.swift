...
extension Strings {
    ...
    public static let ASHighlightsTitle =  NSLocalizedString("ActivityStream.Highlights.SectionTitle", value: "Highlights", comment: "Section title label for Highlights section")
...
extension Strings {
    ...
    public static let AppMenuNewTabTitleString = NSLocalizedString("Menu.NewTabAction.Title", tableName: "Menu", value: "Open a New Tab", comment: "Label for the button, displayed in the menu, used to open a new tab")
    public static let AppMenuNewPrivateTabTitleString = NSLocalizedString("Menu.NewPrivateTabAction.Title", tableName: "Menu", value: "Open a New Private Tab", comment: "Label for the button, displayed in the menu, used to open a new private tab.")
    ...
    public static let AppMenuNightModeIsOnLabel = NSLocalizedString("Menu.NightModeIsOnAction.Label", value: "Disable Night Mode", comment: "Label for the button, displayed in the menu, shows the current state of night mode which is currently ON")
    public static let AppMenuNightModeIsOffLabel = NSLocalizedString("Menu.NightModeIsOffAction.Label", value: "Enable Night Mode", comment: "Label for the button, displayed in the menu, shows the current state of night mode which is currently OFF")
    public static let AppMenuNoImageModeIsOnLabel = NSLocalizedString("Menu.NoImageModeIsOnAction.Label", value: "Show Images", comment: "Label for the button, displayed in the menu, shows the current state of Hide Images mode which is currently ON")
    public static let AppMenuNoImageModeIsOffLabel = NSLocalizedString("Menu.NoImageModeIsOffAction.Label", value: "Hide Images", comment: "Label for the button, displayed in the menu, shows the current state of Hide Images which is currently OFF")
}
